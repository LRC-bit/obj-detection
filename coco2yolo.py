...
# 使用函数进行转换
coco_json_path = 'C:/Users/31006/Desktop/GAIIC2024-赛道1-目标检测任务/train/train.json'  # 替换为实际COCO标注文件路径
output_dir = 'C:/Users/31006/Desktop/GAIIC2024-赛道1-目标检测任务/train/tir'  # 替换为期望的输出目录
