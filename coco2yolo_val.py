...
# 使用函数进行转换
coco_json_path = '/kaggle/input/obj-dataset/GAIIC2024-赛道1-目标检测任务/val/val.json'  # 替换为实际COCO标注文件路径
output_dir = '/kaggle/input/obj-dataset/GAIIC2024-赛道1-目标检测任务/val/tir'  # 替换为期望的输出目录
