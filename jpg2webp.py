...
def process_image_train(i, file_name):
    rgb_path = f"/kaggle/working/GAIIC2024-赛道1-目标检测任务/{file_name}/rgb/{i}.jpg"
    gray_path = f"/kaggle/working/GAIIC2024-赛道1-目标检测任务/{file_name}/tir/{i}.jpg"
    output_path = f"kaggle/working/dataset/{file_name}/{i}.webp"
...
if __name__ == "__main__":
    for file_name in [("train",17991), ("val",1550), ("test",1001)]:
